...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/kivy/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/home/kivy/Project/rats_detector/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/rats_detector/include/python3.8" ],
  CPPINCLUDES => [  ],
  ...
  LDFLAGS => [ "  -L/home/kivy/Project/rats_detector/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/rats_detector/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
