...
#define DATE "built on: Sun Jan 16 13:47:56 2022 UTC"
...
static const char compiler_flags[] = {
    ...
    '/','P','r','o','j','e','c','t','/','r','a','t','s','_','d','e',
    't','e','c','t','o','r','/','.','b','u','i','l','d','o','z','e',
    'r','/','a','n','d','r','o','i','d','/','p','l','a','t','f','o',
    'r','m','/','b','u','i','l','d','-','a','r','m','e','a','b','i',
    '-','v','7','a','/','b','u','i','l','d','/','p','y','t','h','o',
    'n','-','i','n','s','t','a','l','l','s','/','r','a','t','s','_',
    'd','e','t','e','c','t','o','r','/','i','n','c','l','u','d','e',
    '/','p','y','t','h','o','n','3','.','8','\0'
};
